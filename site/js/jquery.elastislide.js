(function( window, $, undefined ) {
	...
	$.elastislide.prototype 	= {
		...
		_addControls		: function() {
			...
			this.$navNext	= $('<span class="es-nav-next"><span></span></span>');
			this.$navPrev	= $('<span class="es-nav-prev"><span></span></span>');
			$('<div class="es-nav"/>')
			.append( this.$navPrev )
			.append( this.$navNext )
			.appendTo( this.$el );
